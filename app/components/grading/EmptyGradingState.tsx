                ...
                >
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <ChevronRight className={`w-5 h-5 text-gray-400 dark:text-gray-600 transition-opacity ${hoveredIndex === index ? 'opacity-100' : 'opacity-0'}`} />
                    </div>

                    {index < steps.length - 1 && (
                      <div
                        className="absolute left-7 top-full h-16 w-px bg-border"
                      />
                    )}
                  </div>
