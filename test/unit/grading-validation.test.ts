  ...
  describe('isValidGradingResult Function', () => {
    it('should accept valid grading results', () => {
      ...
      const validResult = {
        ...
        breakdown: [
          {
            ...
            score: 35,
            feedback:
              'Excellent analysis with clear arguments and supporting evidence. The student demonstrates thorough understanding of the topic.',
          },
          {
        ...
        overallFeedback:
          'Strong work overall. The analysis demonstrates clear understanding with well-supported arguments.',
      };
      ...
      invalidResults.forEach((result, index) => {
        ...
        try {
          ...
          if (isValid && result.breakdown) {
            ...
            const hasErrorMessages = result.breakdown.some(
              (item: any) =>
                item &&
                item.feedback &&
            ...
            if (hasErrorMessages) {
              ...
              const hasValidScores = result.breakdown.some(
                (item: any) => item && typeof item.score === 'number' && item.score > 0
              );

              // Check for valid feedback
              const hasValidFeedback = result.breakdown.some(
                (item: any) => item && item.feedback && typeof item.feedback === 'string' && item.feedback.length > 20 // At least 20 characters
              );
          ...
          breakdown: [
            {
              ...
              score: 35,
              feedback:
                'The essay demonstrates a sophisticated understanding of the topic with well-researched evidence and clear analysis. The arguments are logical and well-supported by credible sources.',
            },
            {
              ...
              score: 27,
              feedback:
                'The essay follows a clear organizational structure with effective transitions between paragraphs. The introduction and conclusion effectively frame the main arguments.',
            },
            {
              ...
              score: 25,
              feedback:
                'Writing demonstrates strong command of academic language with minimal grammatical errors. The tone is appropriate for the academic context.',
            },
          ],
          overallFeedback:
            'This is a well-crafted essay that demonstrates strong analytical thinking and effective communication. The research is thorough and the arguments are compelling. Minor improvements could be made in the depth of analysis for certain points.',
          metadata: {
            provider: 'gemini',
          ...
          breakdown: [
            {
              ...
              score: 33,
              feedback:
                'Strong content with good use of sources. The analysis shows clear understanding of the topic, though some arguments could be developed further with additional evidence.',
            },
            {
              criteriaId: 'writing-structure',
              name: 'Writing Structure',
              score: 25,
              feedback:
                'Well-organized essay with logical flow. The structure supports the argument effectively, though transitions could be smoother in places.',
            },
            {
              criteriaId: 'language-mechanics',
              name: 'Language & Mechanics',
              score: 24,
              feedback:
                "Generally good writing with appropriate academic tone. Some minor errors in punctuation and word choice that don't significantly impact clarity.",
            },
          ],
          overallFeedback:
            'A solid essay that meets most criteria effectively. The content is well-researched and the structure is logical. With attention to the areas noted above, this could be an excellent piece of work.',
          metadata: {
            provider: 'openai',
            model: 'gpt-4',
            processingTime: 4100,
