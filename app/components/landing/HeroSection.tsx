  ...
  return (
    <div className="relative w-full min-h-[700px] overflow-hidden rounded-lg transform-gpu transition-transform duration-300 hover:scale-[1.005]">
      ...
      <button
        ...
        aria-label="開始使用"
      >
        <div className="relative flex items-center justify-center w-20 h-20 rounded-full bg-background transform-gpu transition-all duration-500 hover:scale-110 cursor-pointer">
