      ...
      criteria: [
        {
          ...
          levels: [
            {
              score: 30,
              description: 'Exceptional: Clear, compelling thesis with sophisticated, well-developed arguments',
            },
    ...
    const majorAssignment = await AssignmentAreaFactory.createWithDueDate(
      {
        ...
        description:
          'Comprehensive analysis of a specific climate policy, examining its effectiveness, implementation challenges, and potential improvements. 3000-4000 words.',
      },
      21
    ); // Due in 3 weeks
        ...
        breakdown: [
          {
            ...
            score: 28,
            feedback:
              'Exceptional thesis with sophisticated argumentation. The analysis of EU ETS evolution demonstrates deep understanding of policy complexities. Arguments are well-structured and compelling throughout.',
          },
          {
            ...
            score: 24,
            feedback:
              'Excellent integration of current scholarly sources. The use of Andersson and Johannesson (2023) and Chen et al. (2024) demonstrates engagement with cutting-edge research. Evidence is properly contextualized and supports arguments effectively.',
          },
          {
            ...
            score: 23,
            feedback:
              'Sophisticated critical analysis with original insights. The evaluation of Phase III reforms and Market Stability Reserve shows advanced understanding. Minor opportunity for deeper exploration of carbon leakage implications.',
          },
          {
            ...
            score: 17,
            feedback:
              'Well-organized with strong academic writing style. Clear progression from background through analysis to conclusions. Professional tone maintained throughout with appropriate academic conventions.',
          },
        ],
        overallFeedback:
          'This is an excellent paper that demonstrates sophisticated understanding of carbon pricing policy. The analysis is thorough, well-researched, and provides valuable insights into EU ETS evolution. The writing is clear and professional, meeting high academic standards. This work would be suitable for publication with minor revisions.',
        provider: 'gemini',
        method: 'text',
      }
    );
        ...
        breakdown: [
          {
            ...
            score: 20,
            feedback:
              'Clear thesis about German renewable energy policy, but arguments could be more sophisticated. The basic structure is present but lacks the depth expected at this level.',
          },
          {
            criteriaId: 'research-evidence',
            name: 'Research and Evidence',
            score: 15,
            feedback:
              'Adequate use of sources but limited in scope. Only 8 references for a paper of this scope is insufficient. Integration of sources into arguments could be improved.',
          },
          {
            criteriaId: 'analysis-depth',
            name: 'Critical Analysis',
            score: 20,
            feedback:
              'Some analytical thinking present but tends toward description rather than critical evaluation. The discussion of challenges is relevant but superficial.',
          },
          {
            criteriaId: 'organization-style',
            name: 'Organization and Academic Style',
            score: 19,
            feedback:
              'Well-organized with appropriate academic style. Clear structure with logical flow between sections. Writing is competent though could be more sophisticated.',
          },
        ],
        overallFeedback:
          'This paper demonstrates solid understanding of German renewable energy policy but lacks the depth and sophistication expected at the graduate level. Stronger research foundation and more critical analysis would significantly improve the work. The writing is clear and well-organized.',
        provider: 'openai',
        method: 'text',
      }
    );
        ...
        breakdown: [
          {
            ...
            score: 10,
            feedback:
              'No clear thesis statement. The paper makes general statements about environmental policy without developing coherent arguments or taking a specific analytical position.',
          },
          {
            criteriaId: 'research-evidence',
            name: 'Research and Evidence',
            score: 8,
            feedback:
              'No credible academic sources cited. The paper relies on general statements without supporting evidence. This is inadequate for graduate-level work.',
          },
          {
            criteriaId: 'analysis-depth',
            name: 'Critical Analysis',
            score: 12,
            feedback:
              'Superficial treatment of topics with no meaningful analysis. The discussion remains at a very basic level without demonstrating understanding of policy complexities.',
          },
          {
            criteriaId: 'organization-style',
            name: 'Organization and Academic Style',
            score: 15,
            feedback:
              'Basic organization present but academic style is inappropriate for graduate level. Writing lacks sophistication and professional tone expected in academic work.',
          },
        ],
        overallFeedback:
          'This paper does not meet graduate-level expectations. It lacks a clear thesis, credible research foundation, and meaningful analysis. Significant revision would be needed to meet course standards. Recommend meeting with professor to discuss approach and expectations.',
        provider: 'openai',
        method: 'text',
      }
    );
