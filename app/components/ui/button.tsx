  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        outline:
          'border-2 border-foreground/20 dark:border-foreground/30 bg-background shadow-sm hover:border-accent hover:bg-accent/30 dark:hover:bg-accent/40 hover:shadow-md hover:scale-105 active:scale-95 transition-all',
        ...
        minimal:
          'text-foreground hover:bg-accent/15 dark:hover:bg-accent/25 hover:shadow-md hover:scale-105 active:scale-95 duration-200',
      },
      size: {
        ...
        'icon-2xl': 'h-24 w-24 [&_svg]:size-12',
      },
    },
    defaultVariants: {
      variant: 'default',
