import { Clock, BookOpen, FileText, UserPlus, CheckCircle } from 'lucide-react';
...
export function AssignmentsContent({ data }: AssignmentsContentProps) {
  const { student, assignments, enrolledCourses } = data;
