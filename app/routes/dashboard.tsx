  ...
  return (
    <div className="container py-10 max-w-6xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <DashboardCard title="評分標準" description="管理和編輯評分標準" linkTo="/rubrics" />
      </div>
    </div>
  );
}

function DashboardCard({ title, description, linkTo }: { title: string; description: string; linkTo: string }) {
  return (
