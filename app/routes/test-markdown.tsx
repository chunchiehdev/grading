    ...
    <div className="container mx-auto py-8 max-w-4xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent>
            <pre className="bg-muted p-4 rounded text-sm overflow-x-auto">{testMarkdown}</pre>
          </CardContent>
        </Card>
      ...
      <Card className="mt-6">
        ...
        <CardContent>
          <div className="space-y-2 text-sm">
            <p>
              <strong>粗體文字</strong>：**文字** 會變成粗體
            </p>
            <p>
               <strong>標題</strong>：## 和 ### 會變成不同大小的標題
            </p>
            <p>
               <strong>列表</strong>：- 會變成項目符號列表
            </p>
            <p>
               <strong>有序列表</strong>：1. 會變成數字列表
            </p>
            <p>
               <strong>引用</strong>：{'>'} 會變成引用區塊
            </p>
            <p>
               <strong>換行</strong>：\n 會正確處理段落分隔
            </p>
