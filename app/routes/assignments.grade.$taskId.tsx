...
export const meta = () => {
  return [{ title: '評分系統' }, { name: 'description', content: '教育評分管理平台' }];
};

import type { FeedbackData, ValidationResult, GradingStatus, AssignmentSubmission, Section } from '@/types/grading';
...
export async function action({ request }: ActionFunctionArgs): Promise<ActionData> {
  try {
    ...
    return {
      error: error instanceof Error ? error.message : '系統發生未預期的錯誤，請聯繫系統管理員',
    };
  }
}
